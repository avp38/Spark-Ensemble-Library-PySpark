# Execution: ./bin/spark-submit --master local[8] --driver-memory 12g --executor-memory 12g ~/Desktop/spark_lib/ensemble_cifar.py > ~/Desktop/spark_lib/output/cifar.op
...
ensemble_train_file = "/home/ajit/Desktop/spark_lib/intermediate_output/cifar.ens.train"
ensemble_test_file = "/home/ajit/Desktop/spark_lib/intermediate_output/cifar.ens.test"
